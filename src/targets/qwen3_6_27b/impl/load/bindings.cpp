...
LoadedModelData::LoadedModelData(BindingPlan plan, artifact::MaterializedArtifact materialized)
    ...
    if (plan.features.dflash2()) {
        ...
        dflash2.context_norm =
            artifact::materialized_tensor(backing, source.context_norm, NumericFormat::BF16,
                                          {5120});
        ...
        dflash2.candidate_selector.predecessor_codebook = artifact::materialized_tensor(
            backing, source.candidate_selector.predecessor_codebook, NumericFormat::BF16,
            {256, 248320});
        dflash2.candidate_selector.successor_codebook = artifact::materialized_tensor(
            backing, source.candidate_selector.successor_codebook, NumericFormat::BF16,
            {256, 248320});
    }
